...
const Login = () => {
  return (
    <div className="mt-7 bg-white sm:flex sm:justify-center sm:items-center sm:min-h-full  border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
